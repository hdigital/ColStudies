...
# classes
button = (
    "m-2 p-2 text-xl text-white bg-blue-500 hover:bg-blue-700 rounded-full "
)  # flex items-center'
darabutton = (
    "m-2 p-2 text-xl text-white bg-yellow-500 hover:bg-yellow-700 rounded-full "
)  # flex items-center'
dbkeditbutton = (
    "m-2 p-2 text-xl text-white bg-green-500 hover:bg-green-700 rounded-full "
)  # flex items-center'
starbutton = (
    "m-2 p-2 text-xl text-white bg-gray-500 hover:bg-gray-700 rounded-full "
)  # flex items-center'
actionbutton = (
    "m-2 p-2 text-xl text-white bg-red-500 hover:bg-red-700 rounded-full "
)  # flex items-center'
annotationbutton = (
    "m-2 p-2 text-xl text-white bg-red-500 hover:bg-red-700 rounded-full "
)  # flex items-center'
